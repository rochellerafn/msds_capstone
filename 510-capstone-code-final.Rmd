...
young_sample_trans <- young_sample_trans %>%
  inner_join(x=young_sample_trans, y=young_article_words, by = 'article_id')

str(young_sample_trans)
```

```{r}
rename(young_sample_trans, words = words.x)
```
...
mature_sample_trans <- mature_sample_trans %>%
  inner_join(x=mature_sample_trans, y=mature_article_words, by = 'article_id')
...
```{r}
young_sample_cor <- tm_map(young_sample_cor, removeNumbers)
```

```{r}
mature_sample_cor <- tm_map(mature_sample_cor, removeNumbers)
```
