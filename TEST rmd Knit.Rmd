...
We all know social media has completely changed how people interact and connect. So, why not integrate the shopping experience even more? We're already seeing ads in our feeds based on our web browsing history. But, what if in H&M's own website they allow customers to connect their accounts with friends and family? They can identify and establish connections with other accounts to share desired items, birthdays, anniversaries, graduations and other important dates. 

### Leverage Wishlists
Once the customers have these connections and important event dates saved, increase the functionality of wishlists. Increase a users' capability so that they can create public and shareable wishlists with their connections. Not only would the other customers have access, but now the company knows what items their customers are looking at but also potential purchasers outside of the primary customer. The company could then send email notifications to connections as the customer's birthday or special event gets closer, sending suggested gifts based on these lists or previous purchases. 
